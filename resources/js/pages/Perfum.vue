        ...
        <section
            ...
            <div class="relative z-10 max-w-5xl mx-auto px-6 lg:px-8">
                <div class="text-center mb-16">
                    <svg data-aos="zoom-in-up" data-aos-delay="300" class="w-16 h-16 mx-auto text-amber-400" fill="none"
                ...
                <div class="mt-12 max-w-md mx-auto">
                    ...
                    <p class="text-xs text-amber-500/60 text-center mt-8 max-w-xs mx-auto" data-aos="zoom-in-up"
                       data-aos-delay="300">
